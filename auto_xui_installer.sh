...
echo "========================================"
log "🚀 Начало автоматической установки 3x-ui (v1.0)"
...
ufw reload >/dev/null 2>&1
log_success "ICMP заблокирован, сервер больше не отвечате на ping"
...
echo
echo "💡 БЫСТРЫЙ СТАРТ:"
echo "   1. Откройте панель в браузере по адресу указаному выше"
echo "   2. Нажмите «Дополнительно» → «Перейти» Игнорируем сообщение о якобы не безопасном соединении"
